...
namespace Infrastructure.Repositories
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class, IEntity
    {
        ...
        public GenericRepository(FirebaseRepository firebaseRepo, string? collectionName = null)
        {
            _firebaseRepo = firebaseRepo ?? throw new ArgumentNullException(nameof(firebaseRepo));
            _collectionName = collectionName ?? (typeof(T).Name.ToLower() + "s"); // users, bills, files ...
        }
