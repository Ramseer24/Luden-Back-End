...
namespace Infrastructure.FileStorage
{
    public class FileStorageService : IFileStorageService
    {
        ...
        public async Task<byte[]> GetFile(string relativePath)
        {
            ...
            throw new FileNotFoundException($"File not found with path '{normalizedRelativePath}'");
        }
        ...
        public async Task<string> SaveImageFileAsync(Stream fileStream, string fileName, string category = "image")
        {
            ...
            string relativePath = NormalizePathForUrl(System.IO.Path.Combine(category, year, month, fileNameGuid));
