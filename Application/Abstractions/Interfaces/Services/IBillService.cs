...
namespace Application.Abstractions.Interfaces.Services
{
    ...
    {
        Task<Bill> CreateBillAsync(ulong userId, decimal totalAmount, BillStatus status, string currency = "UAH", int bonusPointsUsed = 0, List<BillItemCreateDto>? items = null);
